package com.rinoarias.appwebholograma.Driver;
...
//        return connect(command);
    ...
    public String obtenerClaveWifi() {
        String command = "c31c" + getWifiPwd + DEFAULT_NO_DATA_LENTH + end;
        return connectRead(command);
    }
    ...
    public String powerOn() {
        if (powerFlag == 0) {
            powerFlag = 1;
            return connect(noDataContentPackage(powerOff));
        }
        powerFlag = 0;
        return connect(noDataContentPackage(powerOn));
    }
